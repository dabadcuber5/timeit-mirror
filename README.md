...
<!--
   ...
   **HINT:**
   The runtimes for indexing into a string are the same as those for indexing a list, are  O(1).
...
| ---------------------- | ---------------- | ---------------- | --------------------- |
| `check_palindrome_1`   |      3.93 msec   |      3.74 msec   |       55.9 msec       |
| `check_palindrome_2`   |      3.42 msec   |      3.22 msec   |        3.3 msec       |
